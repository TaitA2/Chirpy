...
* A Twitter-like backend server built in Go following a guide on [Boot.Dev](https://www.boot.dev/u/taita2) making use of JWTs, PostgreSQL database, webhooks, and API keys.
